...
export const translations = {
  en: {
    ...
    bot: {
      ariaLabel: "Quark, your cloud companion",
      pickerHint: "Meet Quark — pick a mood to keep you company:",
      exprNeutre: "Calm",
      exprAttentif: "Attentive",
      exprSurpris: "Surprised",
      exprExcite: "Excited",
      exprHeureux: "Happy",
      exprHilare: "Laughing",
      exprColere: "Angry",
  ...
  zh: {
    ...
    bot: {
      ariaLabel: "夸克，你的云朵小伙伴",
      pickerHint: "云朵伙伴 Quark · 选一个心情陪伴你：",
      exprNeutre: "平静",
      exprAttentif: "专注",
      exprSurpris: "惊讶",
      exprExcite: "兴奋",
    ...
    me: {
      badge: "个人档案与对话审计",
      title: "个性化与对话审计",
      subtitle: "自定义头像与咨询师形象，审计外部 AI 对话质量。",
      profileTitle: "个人档案",
      profileSub: "你在愈疗对话中的形象",
      displayName: "昵称：",
      displayNamePlaceholder: "例如：小溪、阿May…",
      yourAvatar: "选择或上传你的头像",
      counselorTitle: "咨询师形象",
      counselorSub: "自定义咨询师的姓名与头像",
      defaultVoice: "默认音色",
      counselorNameLabel: "咨询师姓名：",
      counselorNamePlaceholder: "咨询师姓名",
      selectAvatar: "选择或上传头像",
      femalePersona: "🌸 女性咨询师（温暖滋养）",
      malePersona: "🌿 男性咨询师（沉稳理性）",
      saveAll: "保存全部设置",
      savedAll: "设置已保存",
      auditTitle: "外部对话心理审计",
      auditSub: "粘贴其他 AI 或真实对话的记录",
      transcriptLabel: "对话记录：",
      loadSample: "载入示例对话",
      auditBtn: "开始 CBT 审计",
      auditing: "心理审计进行中…",
      clearText: "清空",
      auditLoadingTitle: "MindQuark CBT 引擎审计中…",
      auditLoadingDesc: "评估情绪脆弱点、沟通盲区与认知重构空间。",
      reportTitle: "CBT 心理审计报告",
      featureNote: "评估 AI 回应是接住了情绪，还是流于“正能量说教”。",
      transcriptPlaceholder: "在此粘贴任何对话记录，例如：\n用户：我犯了个小错，感觉天都塌了。\nAI：你只需要严格执行清单就行。",
      sampleDialogue: "用户：我今天工作了 14 个小时，却仍然觉得自己一事无成。\nAI：你应该用番茄工作法优化时间管理，列个待办清单，别再拖延了。",
    },
    voice: {
